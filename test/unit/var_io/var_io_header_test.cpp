...
TEST(var_io_header, spec_from_text)
{
    ...
    EXPECT_EQ(hdr.filters[2].other_fields.size(), 0);
    ...
    EXPECT_EQ(hdr.infos[0].type, bio::var_io::dynamic_type_id::int32);
    ...
    EXPECT_EQ(hdr.infos[1].type, bio::var_io::dynamic_type_id::int32);
    ...
    EXPECT_EQ(hdr.infos[2].type, bio::var_io::dynamic_type_id::vector_of_float32);
    ...
    EXPECT_EQ(hdr.infos[3].type, bio::var_io::dynamic_type_id::string);
    ...
    EXPECT_EQ(hdr.infos[4].type, bio::var_io::dynamic_type_id::flag);
    ...
    EXPECT_EQ(hdr.infos[5].type, bio::var_io::dynamic_type_id::flag);
    ...
    EXPECT_EQ(hdr.formats[0].type, bio::var_io::dynamic_type_id::string);
    ...
    EXPECT_EQ(hdr.formats[1].type, bio::var_io::dynamic_type_id::int32);
    ...
    EXPECT_EQ(hdr.formats[2].type, bio::var_io::dynamic_type_id::int32);
    ...
    EXPECT_EQ(hdr.formats[3].type, bio::var_io::dynamic_type_id::vector_of_int32);
    ...
    ASSERT_EQ(hdr.contigs[0].other_fields.size(), 4);
