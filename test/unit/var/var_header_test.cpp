...
TEST(var_header, spec_from_text)
{
    ...
    EXPECT_EQ(hdr.infos[0].type_id, bio::io::var::value_type_id::int32);
    ...
    EXPECT_EQ(hdr.infos[1].type_id, bio::io::var::value_type_id::int32);
    ...
    EXPECT_EQ(hdr.infos[2].number, bio::io::var::header_number::A);
    EXPECT_EQ(hdr.infos[2].type_id, bio::io::var::value_type_id::vector_of_float32);
    ...
    EXPECT_EQ(hdr.infos[3].type_id, bio::io::var::value_type_id::string);
    ...
    EXPECT_EQ(hdr.infos[4].type_id, bio::io::var::value_type_id::flag);
    ...
    EXPECT_EQ(hdr.infos[5].type_id, bio::io::var::value_type_id::flag);
    ...
    EXPECT_EQ(hdr.formats[0].type_id, bio::io::var::value_type_id::string);
    ...
    EXPECT_EQ(hdr.formats[1].type_id, bio::io::var::value_type_id::int32);
    ...
    EXPECT_EQ(hdr.formats[2].type_id, bio::io::var::value_type_id::int32);
    ...
    EXPECT_EQ(hdr.formats[3].type_id, bio::io::var::value_type_id::vector_of_int32);
