...
bio::io::seq_io::record<std::string_view,                                 // type of the ID field
...
bio::io::seq_io::reader reader{"example.fasta",
                               bio::io::seq_io::reader_options{.record = bio::io::seq_io::record_dna{}}};
...
static_assert(std::same_as<decltype(reader)::record_type,
//![options2_type]
bio::io::seq_io::record<std::string,                            // type of the ID field
