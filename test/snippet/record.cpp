...
auto rec1 = bio::io::make_record(bio::meta::vtag<bio::io::field::id, bio::io::field::seq, bio::io::field::qual>,   // identifiers
                             id, seq, qual);                                                 // values


/* This creates a *shallow* record; it contains references to the above strings/vectors */
auto rec2 = bio::io::tie_record(bio::meta::vtag<bio::io::field::id, bio::io::field::seq, bio::io::field::qual>,    // identifiers
                            id, seq, qual);                                                  // values
//![make_and_tie_record]
