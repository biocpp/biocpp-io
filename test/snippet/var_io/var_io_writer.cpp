...
bio::io::var_io::header header{text_header};

bio::io::var_io::writer writer{"example.vcf"};
...
writer.emplace_back(
    ...
    9.4,
    "q10",
    std::vector{bio::io::var_io::info_element{.id = "DP", .value = 30},
...
writer.set_header(bio::io::var_io::header{text_header});
}
...
{
//![inout]
bio::io::var_io::reader{"example.bcf"} | bio::io::var_io::writer{"example.vcf"};
//![inout]
}
...
r | std::views::filter(pass) | bio::io::var_io::writer{"example.vcf"};
//![inout2]
...
{
//![inout3]
bio::io::var_io::reader reader{"example.bcf"};
