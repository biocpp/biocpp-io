...
#define BIO_VERSION (BIO_VERSION_MAJOR * 10000 \
                   + BIO_VERSION_MINOR * 100 \
                   + BIO_VERSION_PATCH)
...
#define BIO_VERSION_CSTRING_HELPER_FUNC(MAJOR, MINOR, PATCH) \
    ...
    BIO_VERSION_CSTRING_HELPER_STR(MINOR) "."\
    BIO_VERSION_CSTRING_HELPER_STR(PATCH)
...
#define BIO_RELEASE_CANDIDATE_HELPER(RC) \
    "-rc." BIO_VERSION_CSTRING_HELPER_STR(RC)
#else
//!\brief A helper function that expands to a suitable release candidate suffix.
#define BIO_RELEASE_CANDIDATE_HELPER(RC) ""
#endif
...
#define BIO_VERSION_CSTRING \
    BIO_VERSION_CSTRING_HELPER_FUNC(BIO_VERSION_MAJOR, \
                                       BIO_VERSION_MINOR, \
                                       BIO_VERSION_PATCH) \
