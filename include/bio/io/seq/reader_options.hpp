...
/*!\file
 * \brief Provides bio::io::seq::reader_options and various field_types definitions.
...
/*!\brief Options that can be used to configure the behaviour of bio::io::seq::reader.
 * \ingroup seq
 ...
 *
 * \snippet test/snippet/seq/seq_reader_options.cpp example_simple
 *
 ...
 *
 * Typically, the options are set as part of the bio::io::seq::reader construction. See the respective
...
struct reader_options
{
     ...
     * \details
     *
     * See bio::io::seq::reader for an overview of the the supported formats.
     */
     ...
     * \details
     *
     * See bio::io::seq::record for details.
     */
    record_t record{};
