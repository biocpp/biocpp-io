...
/*!\file
 * \brief Provides bio::io::txt::reader.
 ...
 * ```cpp
 * bio::io::txt::reader reader{"foobar.txt"}
 *
 ...
 * ```cpp
 * bio::io::txt::reader reader{"example.vcf.gz", '\t', bio::io::txt::header_kind::starts_with{'#'}};
 *
 * // print header
...
public:
     ...
     * \param[in] header          Whether to treat certain lines as header; see bio::io::txt::header_kind.
