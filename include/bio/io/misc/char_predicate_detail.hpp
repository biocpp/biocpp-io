 ...
 * \relates bio::io::detail::char_predicate
 */
...
/*!\interface bio::io::detail::char_predicate <>
 * \brief An internal concept to check if an object fulfills the requirements of a bio::io::detail::char_predicate.
 * \ingroup io
 *
 * \details
 *
...
/*!\name Requirements for bio::io::detail::char_predicate
 ...
 * \memberof bio::io::detail::char_predicate
 ...
 *                   Must model bio::io::detail::char_predicate.
 */
...
struct char_predicate_base
{
     ...
     * \{
     */
    //!\brief Combines the result of two bio::io::detail::char_predicate via logical disjunction.
 ...
 * \implements bio::io::detail::char_predicate
 * \tparam condition_ts Template parameter pack over all parse condition types. Must contain at least 2 template
 * parameters. Must model bio::io::detail::char_predicate. \ingroup io
 */
template <char_predicate... condition_ts>
    //!\cond
    requires(sizeof...(condition_ts) >= 2)
