...
#include <bio/io/misc/char_predicate_detail.hpp>
 ...
 * ### Example
 *
 * \include test/snippet/misc/char_predicate_is_in_interval.cpp
 * \hideinitializer
 */
 ...
 * ### Example
 *
 * \include test/snippet/misc/char_predicate_is_char.cpp
 * \hideinitializer
 */
template <int char_v>
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_eof
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_cntrl
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_print
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_space
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_blank
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_graph
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_punct
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_alnum
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_alpha
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_upper
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_lower
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_digit
 */
 ...
 * ### Example
 *
 * \snippet test/snippet/misc/char_predicate.cpp is_xdigit
 */
 ...
 *
 * \include test/snippet/misc/char_predicate_is_operator.cpp
 *
 ...
 * ### Custom predicates
 *
 * * bio::io::is_in_interval: Checks if the given character is within specified range of ASCII characters.
 * * bio::io::is_char: Checks if the character is equal to the specified ASCII character.
 * * bio::io::is_eof: Checks if a character is the end-of-file marker.
 *
 ...
 * \endcond
 *
 *<table class="wikitable" style="background-color:#ededed;font-size:85%;text-align:center;border: 1px solid
 ...
 *</td>
 *<td style="background: #90ff90; color: black; vertical-align: middle; text-align: center; border: 1px solid black;"
 *class="table-yes"><b><code>≠0</code></b>
 *</td>
 *<td style="background:#ff9090; color:black; vertical-align: middle; text-align: center; border: 1px solid black;"
 *class="table-no"> <b><code>0</code></b>
 *</td>
 *<td style="background:#ff9090; color:black; vertical-align: middle; text-align: center; border: 1px solid black;"
 *class="table-no"> <b><code>0</code></b>
 *</td>
