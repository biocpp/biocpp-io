...
/*!\file
 * \brief Provides bio::io::var::reader_options.
...
/*!\brief Options that can be used to configure the behaviour of bio::io::var::reader.
 ...
 * \details
 *
 * This object can be configured in a similar way as bio::io::seq::reader_options.
 * If you are new to the way options are set in this library, have a look at
 * bio::io::seq::reader first.
 *
 * ### Example
 *
...
struct reader_options
{
     ...
     * \details
     *
     * See bio::io::var::reader for an overview of the the supported formats.
     */
